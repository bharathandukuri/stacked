...
public interface FileService {
    ...
    /**
     * Upload a file to temporary storage. Automatically expires based on configured TTL.
     */
    @NonNull
    ...
    /**
     * Move a temporary file to permanent storage for internal module consumers (e.g. Assessment/Question bank).
     */
    @NonNull
